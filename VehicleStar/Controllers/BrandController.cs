...
namespace VehicleStar.Controllers
{
    public class BrandController : Controller
    {
        ...
        public IActionResult Edit(Brand brand)
        {
            ...
            if (ModelState.IsValid)
            {
                /*   var objFromDb = _dbContext.Brand.AsNoTracking().FirstOrDefault(x => x.Id == brand.id);
                     ...
                     objFromDb.EstablisherYear = brand.EstablisherYear;
                ...
                TempData["waring"] = "Recored Updated Succesfully";
        ...
        public IActionResult Delete(Brand brand)
        {
            ...
            TempData["erroe"] = "Recored Deleted Succesfully";
